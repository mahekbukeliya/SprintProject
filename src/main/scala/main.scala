...
object main {
  def main(args: Array[String]): Unit = {
    ...
    val rawDF = spark.read
      ...
      .json("/home/runali/Dataset/raw_data.json")

    // Reading Modified Data
    val modifiedDF = spark.read
      .schema(logSchema)
      .option("multiline", "true")
      .json("/home/runali/Dataset/modified_data.json")
    ...
    cleanedModifiedDF.write
      ...
      .save("/home/runali/Dataset/Logs/delta_logs")
    ...
    // Call CDC Pipeline
    CDC.applyCDC(cleanedDF, cleanedModifiedDF, "/home/runali/Dataset/Logs/delta_logs")

    // Show final Delta table
    spark.read
      .format("delta")
      .load("/home/runali/Dataset/Logs/delta_logs")
      .show(false)
